...
# --- README WITH EXPLICIT LINK ---
# We are adding a huge text link at the top, not just a badge.
...
if __name__ == "__main__":
    ...
    print("✅ README.md updated with a BIG link at the top.")
    print("👉 Now: git add . && git commit -m 'Added link' && git push")